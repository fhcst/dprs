# badge-detail-modal Specification

## Purpose

Provides the badge detail modal UI for teachers on the badge management page, allowing teachers to view awarded and not-awarded students per badge, manually award badges from the modal, and revoke badge awards.
...
<!-- @trace
source: badge-detail-and-revoke
updated: 2026-04-04
-->
...
code:
  ...
  - src/templates/teacher/trigger-rules.html
